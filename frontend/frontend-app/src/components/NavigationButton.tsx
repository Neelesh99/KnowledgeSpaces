...
export const NavigationButton = ({ title, link }: { title: string, link: string }) => {
    ...
    const selectedStyle = "flex w-32 h-12 bg-slate-600 rounded-sm items-center font-special text-lg cursor-pointer transition justify-center hover:bg-gradient-to-r from-emerald-500 to-sky-500"
