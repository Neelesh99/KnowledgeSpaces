...
export default function Home(props: HomeProps) {
    ...
    return <div className="flex flex-col">
        <div className="w-full flex h-fit">
            <div className="w-1/2 bg-sky-100 text-8xl font-special px-6 py-12">
                A space for your stuff, with GPT powered queries
            </div>
            <div className="w-1/2 bg-sky-100 p-12">
                <div className="flex flex-col place-content-between h-full w-full bg-slate-100 rounded-xl">
                    ...
                    <div
                        ...
                        className="flex w-full h-12 rounded-b-xl justify-center py-3 cursor-pointer transition duration-300 hover:bg-teal-500 hover:text-white">
                        Sign-up now
                    </div>
                </div>
            </div>
